  ...
  <div class="app-container calendar-list-container">
    <div class="table-responsive">
      <table id="healthCheck" class="el-table">
        ...
        <tbody>
        <tr v-for="(health,index) in healthData">
          <td>{{baseName(health.name)}} {{subSystemName(health.name)}}</td>
          <td class="text-center">
                                    <span class="badge" :class="getBadgeClass(health.status.code)">
                                        {{health.status.code}}
                                    </span>
          </td>
          <td class="text-center">
      ...
      <el-dialog :title="baseName(currentHealth.name)+' '+subSystemName(currentHealth.name)" :visible.sync="dialogVisible">
        ...
        <div v-show="currentHealth.details">
          <div class="table-responsive">
            <table class="el-table">
              ...
              <tbody>
              <tr v-for="(entry, key,index) in currentHealth.details.details">
