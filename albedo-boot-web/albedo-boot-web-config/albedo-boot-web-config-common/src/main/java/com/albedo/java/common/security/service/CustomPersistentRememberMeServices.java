...
//        PersistentToken token = userRepository.findOneByLoginId(login).map(u -> {
...
//            throw new RememberMeAuthenticationException("No persistent token found for series series: " + presentedSeries);
//        }
//
