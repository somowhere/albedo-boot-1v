...
//                null,null);
//
//        restUserMockMvc.perform(post(applicationProperties.getAdminPath("/sys/user/"))
...
//        // Get all the users
//        restUserMockMvc.perform(get(applicationProperties.getAdminPath("/sys/user/"))
...
//
//        // Get the user
//        restUserMockMvc.perform(get(applicationProperties.getAdminPath("/sys/user/{id}"), user.getId()))
//                .andExpect(status().isOk())
//                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
...
//
//        // Delete the user
//        restUserMockMvc.perform(put(applicationProperties.getAdminPath("/sys/user/{id}"), user.getId())
...
//
//        // Delete the user
//        restUserMockMvc.perform(delete(applicationProperties.getAdminPath("/sys/user/{id}"), user.getId())
//                .accept(TestUtil.APPLICATION_JSON_UTF8))
//                .andExpect(status().isOk());
//
//        // Validate the database is empty
...
//        restUserMockMvc.perform(get(applicationProperties.getAdminPath("/sys/user/authorities"))
//                .accept(TestUtil.APPLICATION_JSON_UTF8)
//                .contentType(TestUtil.APPLICATION_JSON_UTF8))
//                .andExpect(status().isOk())
